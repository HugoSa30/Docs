...

{
  ...
  *unaff_r30 = *unaff_r30 & 0xfd;
  if ((unaff_r29 == 0) || (DAT_003fb319 != '\0')) {
    DAT_003fb318 = '\0';
  }
  else {
    DAT_003fb318 = '\x01';
  }
  DAT_003fb319 = '\x01' - (unaff_r29 == 0);
  if (DAT_003fb318 != '\0') {
    DAT_005b89f5 = tumg;
  }
  ...
  if (DAT_005b89e6 < 1) {
    iVar2 = -(int)DAT_005b89e6;
  }
  else {
    iVar2 = (int)DAT_005b89e6;
  }
  if (iVar2 < _DAT_001c8452) {
    DAT_005b89f0 = '\x03';
  }
  ...
  if (DAT_005b89f0 == '\x01') {
    uVar4 = (uint)_DAT_001c844e;
  }
  else if (DAT_005b89f0 == '\x02') {
    uVar4 = (uint)_DAT_001c8450;
  }
  else {
    uVar4 = (uint)_DAT_001c844c;
  }
  DAT_005b89de = (undefined2)uVar4;
  if (DAT_005b89e6 < 1) {
    iVar2 = -(int)DAT_005b89e6;
  }
  else {
  ...
  if (DAT_005b89f1 == '\x01') {
    uVar3 = (uint)_DAT_001c8456;
  }
  else if (DAT_005b89f1 == '\x02') {
    uVar3 = (uint)_DAT_001c8458;
  }
  else {
    uVar3 = (uint)_DAT_001c8454;
  }
  DAT_005b89e0 = (undefined2)uVar3;
  DAT_005b89dc = (short)((int)(((int)((int)DAT_005b89e6 * uVar4) >> 1) * (uint)_DAT_001c844a) /
                        500000) + DAT_005b89dc;
  ...
  DAT_005b89e2 = (short)((int)((int)DAT_005b89e6 * uVar3) / 1000);
