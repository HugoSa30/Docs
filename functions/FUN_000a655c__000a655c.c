/*
 * Program: n42.bin
 * Function: FUN_000a655c
 * Entry: 000a655c
 * Exported by: ExportAllDecompiledFunctions.java
 */


void FUN_000a655c(undefined4 param_1,undefined param_2,int param_3,int param_4,undefined4 param_5,
                 int param_6)

{
  ...
  if (param_6 == 0xff) {
    ...
    if (cVar2 == '\0') {
      ...
      cVar2 = FUN_000a5d64(param_2);
      if (cVar2 == '\0') {
        FUN_000a6090(param_2);
        FUN_000a60b0(param_2);
      }
    }
  }
  else {
