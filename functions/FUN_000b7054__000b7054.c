...

{
  ...
  FUN_000b291c((double)(float)in_f6,(double)(float)fflutn_f,&DAT_003fa82c);
  if (B_lustop != 0) {
    _DAT_003fa82c = _DAT_0001bd30;
  }
  _DAT_003fa6dc = _DAT_003fa82c;
