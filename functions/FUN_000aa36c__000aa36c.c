/*
 * Program: n42.bin
 * Function: FUN_000aa36c
 * Entry: 000aa36c
 * Exported by: ExportAllDecompiledFunctions.java
 */


int FUN_000aa36c(uint param_1,short *param_2,uint param_3,byte *param_4,undefined4 param_5,
...

{
  ...
  sVar1 = FUN_000ab038(param_5,param_3,uVar4 + iVar6 * 0x10000,uVar5 + iVar7 * 0x10000);
  return (int)sVar1;
}
