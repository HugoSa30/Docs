...

{
  ...
  *unaff_r24 = unaff_r31;
  if (((DAT_001caf52 < imlatm) && (DAT_001caf54 < nmot)) && (DAT_001caf58 < vfzg)) {
    sVar5 = (ushort)tans * 3 - (short)((int)DAT_001caf51 << 2);
  }
  else {
    sVar5 = (short)((int)*unaff_r27 << 2) + 0xc0;
  }
  sVar5 = (sVar5 >> 2) + -0x30;
  if (sVar5 < -0x80) {
    sVar5 = -0x80;
  ...
  *unaff_r24 = (char)sVar5;
  ...
  if ((DAT_001caf4e == DAT_005b8ab6) && (unaff_r30 == 0)) {
    ...
    if (tabst_w < 2) {
      dVar6 = 4503599627370497.0 - (double)_DAT_0001cc4c;
    }
    else {
      dVar6 = (double)CONCAT44(0x43300000,(uint)tabst_w) - (double)_DAT_0001cc4c;
    }
    _DAT_003fb490 = (float)dVar6;
...
LAB_00140fac:
  ...
  if ((DAT_005b8ab6 != DAT_001caf4e) && (*unaff_r28 == '\0')) {
    dVar6 = (double)_DAT_0001cc48;
    _DAT_003fb418 =
         (float)((double)CONCAT44(0x43300000,
                                  (int)(short)DAT_005b8aba - (int)DAT_003fddc8 ^ 0x80000000) - dVar6
                );
    _DAT_003fb4a4 = (float)((double)CONCAT44(0x43300000,(int)DAT_005b8aba ^ 0x80000000) - dVar6);
    if (tabst_w < 2) {
      dVar7 = 4503599627370497.0;
    }
    else {
      dVar7 = (double)CONCAT44(0x43300000,(uint)tabst_w);
    }
    _DAT_003fb490 = (float)(dVar7 - (double)_DAT_0001cc4c);
    _DAT_003fb414 = _DAT_003fb418 / _DAT_003fb490;
    _DAT_003fb424 = _DAT_003fb414 / _DAT_001caf6c;
    _DAT_003fb41c = (float)((double)CONCAT44(0x43300000,(int)DAT_003fddc8 ^ 0x80000000) - dVar6);
