...

{
  ...
  if ((DAT_001caf4e == unaff_r30) && (*unaff_r28 != '\0')) {
  ...
  if ((*unaff_r24 != DAT_001caf4e) && (*unaff_r28 == '\0')) {
    ...
    if (tabst_w < 2) {
      dVar3 = 4503599627370497.0;
    }
    else {
      dVar3 = (double)CONCAT44(0x43300000,(uint)tabst_w);
    }
    _DAT_003fb490 = (float)(dVar3 - (double)_DAT_0001cc4c);
