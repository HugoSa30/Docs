...

{
  ...
  FUN_000b291c((double)(float)in_f6,(double)(float)fflutn_f,&DAT_003fa7f4);
  if (B_lustop != 0) {
    _DAT_003fa7f4 = _DAT_0001bd30;
  }
  _DAT_003fa6cc = _DAT_003fa7f4;
