...

{
  ...
  if (((*(byte *)(unaff_r30 + 0x165) & 1) == 0) && ((*(byte *)(unaff_r30 + 0x15f) & 1) == 0)) {
  ...
  uVar1 = *unaff_r31;
  if ((((((uVar1 & 1) == 0) && ((uVar1 & 0x80) == 0)) && ((uVar1 & 2) == 0)) &&
      (((uVar1 & 4) == 0 && ((uVar1 & 8) == 0)))) &&
     (((uVar1 & 0x10) == 0 && (((uVar1 & 0x20) == 0 && ((uVar1 & 0x40) == 0)))))) {
  ...
  if (DAT_005b89f0 == '\x01') {
    uVar5 = (uint)_DAT_001c844e;
  }
  else if (DAT_005b89f0 == '\x02') {
    uVar5 = (uint)_DAT_001c8450;
  }
  else {
    uVar5 = (uint)_DAT_001c844c;
  }
  DAT_005b89de = (undefined2)uVar5;
  if (DAT_005b89e6 < 1) {
    iVar3 = -(int)DAT_005b89e6;
  }
  else {
  ...
  DAT_005b89dc = (short)((int)(((int)((int)DAT_005b89e6 * uVar5) >> 1) * (uint)_DAT_001c844a) /
                        500000) + DAT_005b89dc;
