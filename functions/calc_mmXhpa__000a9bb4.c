/*
 * Program: n42.bin
 * Function: calc_mmXhpa
 * Entry: 000a9bb4
 * Exported by: ExportAllDecompiledFunctions.java
 */


int calc_mmXhpa(ushort *param_1,uint param_2,uint param_3)

{
  ...
  sVar4 = FUN_000ab038(puVar3 + uVar7,uVar7,uVar8 + iVar5 * 0x10000,uVar9 + iVar10 * 0x10000);
  return (int)sVar4;
}
