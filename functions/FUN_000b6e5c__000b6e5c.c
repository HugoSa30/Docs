...

{
  ...
  FUN_000b291c((double)(float)in_f6,(double)(float)fflutn_f,&DAT_003fa794);
  if (B_lustop != 0) {
    _DAT_003fa794 = _DAT_0001bd30;
  }
  _DAT_003fa6c0 = _DAT_003fa794;
