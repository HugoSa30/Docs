...

{
  ...
  FUN_000b291c((double)(float)in_f6,(double)(float)fflutn_f,&DAT_003fa7f0);
  if (B_lustop != 0) {
    _DAT_003fa7f0 = _DAT_0001bd30;
  }
  _DAT_003fa6b8 = _DAT_003fa7f0;
