/*
 * Program: n42.bin
 * Function: FUN_0013c6dc
 * Entry: 0013c6dc
 * Exported by: ExportAllDecompiledFunctions.java
 */


void FUN_0013c6dc(undefined4 param_1,uint param_2,int param_3,uint param_4,byte *param_5,
  ...
  do {
    ...
    do {
      ...
      while( true ) {
        ...
        if ((*(ushort *)(unaff_r29 + unaff_r31 + 4) >> 1 & 1) == 0) break;
        if (((*(ushort *)(unaff_r29 + unaff_r31 + 4) >> 2 & 1) == 0) &&
           (*(char *)((uint)(*(ushort *)(unaff_r29 + unaff_r31 + 4) >> 8) * 0xd + 0x1d44b5) ==
            '\x01')) {
          *(ushort *)(unaff_r29 + unaff_r31 + 4) =
    ...
    } while ((*(ushort *)(unaff_r29 + unaff_r31 + 4) >> 2 & 1) != 0);
    in_cr0 = ((*(ushort *)(unaff_r29 + unaff_r31 + 2) & 1) == 0) << 1;
  } while( true );
}
