/*
 * Program: n42.bin
 * Function: FUN_000aa054
 * Entry: 000aa054
 * Exported by: ExportAllDecompiledFunctions.java
 */


undefined FUN_000aa054(uint param_1,byte *param_2,uint param_3,ushort *param_4,undefined4 param_5,
...

{
  ...
  if (((int)(uint)*param_2 < (int)param_6) &&
    ...
    if ((int)param_6 < (int)(uint)param_2[iVar6]) {
      pbVar3 = param_2 + iVar6;
      do {
        iVar6 = iVar6 + -1;
        pbVar3 = pbVar3 + -1;
      } while ((int)param_6 < (int)(uint)*pbVar3);
    }
    if (param_2[iVar6] != param_6) {
      uVar5 = ((param_6 - param_2[iVar6]) * 0x10000) /
  ...
  uVar1 = calc_vanos_optimal(param_5,param_3,uVar5 + iVar6 * 0x10000,uVar4 + iVar7 * 0x10000);
  return uVar1;
}
