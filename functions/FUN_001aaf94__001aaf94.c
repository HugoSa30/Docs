...
undefined4 FUN_001aaf94(int param_1,uint param_2,short param_3)

{
  ...
  if (param_3 == 0) {
    ...
    if (*(byte *)(param_1 + 0x17501) != 1) {
      _DAT_003fa368 = 10;
      return 10;
    }
    (*(code *)&SUB_0001655c)
              (uRam000175c8,*(undefined4 *)(param_1 + 0x174f8),uVar3 & 0xffff,param_2 & 0xffff,
               *(undefined *)(param_1 + 0x17506),0xff);
  }
  return 0;
}
