...
void FUN_00140664(undefined4 param_1,undefined4 param_2)

{
  ...
  func_0xff222514(unaff_r30,param_2,_DAT_001cad8e);
  DAT_005b8a90 = (undefined2)((uint)*unaff_r30 >> 0x10);
  *unaff_r28 = 0;
  if (DAT_001cadc0 == '\x01') {
    _DAT_003fb3fc = 0;
  }
