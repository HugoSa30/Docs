  ...
  if (param_1 == 0) {
    ...
    *_DAT_003fbcb8 = _DAT_002fc014;
    ...
    if (bVar1 != fmfkrakt) {
      ...
      if (bVar1 < 0x11) {
        _DAT_003faf84 = (uint)*(byte *)(bVar1 + 0x1c788);
      }
      else {
        _DAT_003faf84 = 0;
      }
    ...
    _DAT_002fc014 = uVar12;
    AS_ksa3._0_1_ = bVar9;
    FUN_0009bbb0(2,(byte)AS_ksa3 & 1 | ((byte)AS_ksa3 >> 1 & 1) << 1 | ((byte)AS_ksa3 >> 2 & 1) << 2
                );
    ...
    if (((B_c95ks3 == '\0') && ((AS_ksa3._0_1_ >> 2 & 1) == 0)) && (B_krmfok != '\0')) {
      wmfa = wmfa_new;
      wmfl = wmfl_new;
      uVar11 = (*(code *)&SUB_0006997c)
                         (((uint)wmfa_new * 0x4b) / 10 + 0x438,0x28,((uint)wmfl_new * 0x4b) / 10,10,
                          0x708,1);
    }
  }
  else {
