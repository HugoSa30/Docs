...

{
  ...
  sVar4 = ((short)(in_r12 + 0xc0) >> 2) + -0x30;
  if (sVar4 < -0x80) {
    sVar4 = -0x80;
  }
  else if (0x7f < sVar4) {
  ...
  *unaff_r24 = (char)sVar4;
  ...
  if (((DAT_001caf4e == DAT_005b8ab6) && (*unaff_r28 == '\0')) &&
    ...
    if (B_pwf == '\0') {
      ...
      if (uVar5 < _DAT_001caf48) goto LAB_00140fac;
    }
