...

{
  ...
  FUN_000b291c((double)(float)in_f6,(double)(float)fflutn_f,&DAT_003fa790);
  if (B_lustop != 0) {
    _DAT_003fa790 = _DAT_0001bd30;
  }
  _DAT_003fa6c4 = _DAT_003fa790;
