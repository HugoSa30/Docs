...

{
  ...
  uVar6 = (unaff_r29 & 0xffff) * (uint)_DAT_001cad18 >> 0xe;
  if (0xffff < uVar6) {
    uVar6 = 0xffff;
  }
  DAT_005b8a70 = (undefined2)uVar6;
  if (unaff_r26 < 8) {
                    /* WARNING: Could not emulate address calculation at 0x0013fcbc */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(unaff_r26 * 4 + 0xf3fcc8))();
    return;
  }
  iVar2 = (int)((uint)geni_end * (uint)DAT_001cad9b) >> 3;
  DAT_005b8a6e = (undefined2)iVar2;
  uVar3 = (uint)(iVar2 * iVar2) >> 10;
  DAT_005b8a66 = (undefined2)uVar3;
  DAT_005b8a9c = (uVar6 & 0xffff) * uVar3 >> 2;
  if (unaff_r26 < 8) {
  ...
  iVar2 = (int)((uint)geni_end * (uint)DAT_001cad92) >> 3;
  DAT_005b8a6c = (undefined2)iVar2;
  if (unaff_r26 < 8) {
  ...
  DAT_005b8a94 = iVar2 * (uint)DAT_001cadc1 * 4;
  if (unaff_r26 < 8) {
  ...
  uVar6 = func_0xff2189bc(&DAT_001ca6fe,gentemp);
  uVar6 = DAT_005b8a94 * (uVar6 & 0xff);
  DAT_005b8aa0 = uVar6 >> 7;
  uVar6 = (DAT_005b8a9c >> 9) + (uVar6 >> 0x10);
  if (0xffff < uVar6) {
    uVar6 = 0xffff;
  }
  DAT_005b8a72 = (ushort)uVar6;
  if (*unaff_r30 < 8) {
  ...
  uVar6 = func_0xff2189bc(&DAT_001ca9e0,DAT_005b9b08);
  if (DAT_001cadb7 < *unaff_r23) {
    ...
    uVar3 = func_0xff2187cc(&DAT_001cab70,geni_end);
  }
  else {
    if (*unaff_r30 < 8) {
    ...
    uVar3 = func_0xff2187cc(&DAT_001caab0,geni_end);
  }
  uVar6 = (((uint)DAT_005b8a72 * (uVar6 & 0xffff) >> 2) * (uVar3 & 0xff)) / 0x60000;
  if (0x100 < uVar6) {
    uVar6 = 0x100;
  }
  DAT_005b8a64 = (undefined2)uVar6;
  uVar6 = uVar6 * 3;
  DAT_005b8a60 = (undefined2)uVar6;
  if (DAT_005b8a62 < uVar6) {
    DAT_005b8ec5 = '\x01';
  }
  else if (uVar6 < DAT_005b8a62) {
    DAT_005b8ec5 = '\0';
  }
  if (DAT_005b8ec5 == '\0') {
    if (DAT_001cadb7 < *unaff_r23) {
  ...
  func_0xff222514(&DAT_003fb3f0,uVar6,uVar1);
